...
CREATE TABLE  CUSTOMER(
	...
	LAST_NAME CHARACTER VARYING(100) NOT NULL,s
...
--DELETE COLUMN
ALTER TABLE CUSTOMER DROP COLUMN ACTIVE BOOLEAN;
...
INSERT INTO CUSTOMER (FIRST_NAME,LAST_NAME,EMAIL,CREATED_DATE,UPDATED_DATE,ACTIVE) VALUES 
	('Dev','shah','devshah@gmail.com',now(),NULL,true);

INSERT INTO CUSTOMER (FIRST_NAME,LAST_NAME,EMAIL,CREATED_DATE,UPDATED_DATE,ACTIVE) VALUES 
	('A','shah','devshah3@gmail.com',now(),NULL,true);
INSERT INTO CUSTOMER (FIRST_NAME,LAST_NAME,EMAIL,CREATED_DATE,UPDATED_DATE,ACTIVE) VALUES 
	('B','shah','devshah2@gmail.com',now(),NULL,true);
INSERT INTO CUSTOMER (FIRST_NAME,LAST_NAME,EMAIL,CREATED_DATE,UPDATED_DATE,ACTIVE) VALUES 
	('C','shah','devshah1@gmail.com',now(),NULL,true);
...
INSERT INTO customer (first_name, last_name, email, created_date, updated_date,active) VALUES
  ...
  ('Dev', 'shah', 'Devshah@example.com', NOW(), NULL,false);
...
FROM
	customer
WHERE
	first_name = 'Dev' AND last_name = 'Parejiya';
